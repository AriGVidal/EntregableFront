...
import LoguearOpciones from "./LoguearOpciones";
...
class Historia extends React.Component {
    ...
    handlerClick = (opcElegida) => {
        ...
        if (siguienteHistoria != null) {
            ...
            alert("Esta hilarante historia ha finalizado")
        }
    }
        ...
        return (
            (this.state.historiasList.length === 0) ?
                ...
                <div className="layout">
                    ...
                    <LoguearOpciones opcionElegida={this.state.opcionElegida} opcionesElegidas={this.state.opcionesElegidas} />
                </div>
